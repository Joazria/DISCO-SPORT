Rails.application.configure do
  ...
  config.action_cable.url = 'wss://www.discosport.tv/cable'
  config.action_cable.allowed_request_origins = [ 'http://www.discosport.tv', 'https://www.discosport.tv' ]
  ...
  # config.active_job.queue_name_prefix = "DISCO_SPORT_production"
